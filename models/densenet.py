...
def DenseNet100(num_classes, normalizer=None):
    logging.info("Setting up DenseNet100")
    return DenseNet3(depth=100, num_classes=num_classes, normalizer=normalizer)